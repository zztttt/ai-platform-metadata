...
//            }
    ...
    public static String getData(String tableName, String windCode, String dateStr, String dbColumn){
        ...
        try{
            ...
            String sql = FailSqlUtils.selectData(tableName, windCode, dateStr, dbColumn);
    ...
    public static boolean updateData(String tableName, String windCode, String dateStr, String windColumn, String value){
        ...
        try{
            ...
            String sql = FailSqlUtils.update(tableName, windCode, dateStr, attributions, values);
    ...
    public static boolean insertData(String tableName, String windCode, String dateStr, String windColumn, String value){
        ...
        try{
            ...
            String sql = FailSqlUtils.insert(tableName, windCode, dateStr, attributions, values);
    ...
    public static boolean isLineExisting(String tableName, String windDbColumn, String dateDbColumn, String windCode, String dateStr){
        ...
        try{
            conn = DriverManager.getConnection(url, username, password);
            stat = conn.createStatement();
            String sql = FailSqlUtils.selectLine(tableName, windDbColumn, dateDbColumn, windCode, dateStr);
